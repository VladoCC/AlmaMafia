    ...
    private suspend fun ContainerBlock.BasicContext.adminCommands() {
        if (isAdmin(chatId)) {
            ...
            simple(adNewCommand) {
                ...
                ).inlinekeyboard { button(closePopupCommand, chatId) }.callback { msgId ->
            ...
            simple(adminCommand, adminPanelCommand, adminPanelLegacyCommand) {
                ...
                bot.sendmessage(
                    chatId,
                    "Меню администратора:"
                ).callback { messageId -> showAdmin(chatId, messageId, bot) }
            }
    ...
    private suspend fun ContainerBlock.ParametrizedContext.adminQueries() {
        if (isAdmin(chatId)) {
            ...
            parametrized(hostSettingsCommand) {
                showHostSettings(long(0), chatId, bot, int(1))
            }
            ...
            parametrized(deleteHostCommand) {
                ...
                showHostSettings(long(1), chatId, bot, int(2))
            }
