...
val toggleHideRolesModePreviewCommand = command("😑 Скрывать роли", "toggleHideRolesModePreview", 1)
...
val startRevealingRolesCommand = command(name = "😐 Начать показывать роли", "startRevealingRoles", 1)
