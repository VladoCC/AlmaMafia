...
val listHostSettingsCommand = command("Список ведущих", "listHostSettings", 2)
...
val listHostOptionsCommand = command("Список настроек ведущих", "listHostOptions", 2)
...
val deleteHostCommand = command("❌ Удалить ведущего", "deleteHost", 3)
